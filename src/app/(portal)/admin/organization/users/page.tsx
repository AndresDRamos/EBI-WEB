...
/**
 * Usuarios tab (Organización). Loads the full result set server-side and
 * renders a single generic DataTable (Nombre/Usuario/Departamento(s)/Rol(es)/
 * Planta(s)) with the reused UserFormDialog for create/edit.
 */
