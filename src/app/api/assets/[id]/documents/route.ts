...
/** GET /api/assets/[id]/documents — document metadata list (any user). */
...
/**
 * POST /api/assets/[id]/documents — multipart upload (admin).
...
export async function POST(
  ...
  try {
    ...
    const res = authErrorResponse(err);
    if (res) return res;
    console.error("POST /api/assets/[id]/documents failed:", err);
    return NextResponse.json(
