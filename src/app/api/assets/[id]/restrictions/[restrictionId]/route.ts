...
/** PUT /api/assets/[id]/restrictions/[restrictionId] — update (admin). */
export async function PUT(
  ...
  try {
    ...
    if (res) return res;
    console.error("PUT /api/assets/[id]/restrictions/[restrictionId] failed:", err);
    return NextResponse.json(
...
/** DELETE /api/assets/[id]/restrictions/[restrictionId] — soft delete (admin). */
export async function DELETE(
  ...
  try {
    ...
    const res = authErrorResponse(err);
    if (res) return res;
    console.error("DELETE /api/assets/[id]/restrictions/[restrictionId] failed:", err);
    return NextResponse.json(
