...
/** GET /api/assets/[id]/restrictions — list (any authenticated user). */
...
/** POST /api/assets/[id]/restrictions — create (admin). */
export async function POST(
  ...
  try {
    ...
    const res = authErrorResponse(err);
    if (res) return res;
    console.error("POST /api/assets/[id]/restrictions failed:", err);
