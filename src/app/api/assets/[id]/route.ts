...
/** GET /api/assets/[id] — full detail (any authenticated user). */
...
/** PATCH /api/assets/[id] — update fields and/or replace processes (admin). */
...
/** DELETE /api/assets/[id] — soft delete (admin). Assets are history-bearing. */
