...
/**
 * Create/edit modal for a maintenance asset. POSTs or PATCHes /api/maintenance/assets.
...
function MachineFormDialogInner({
  ...
  async function onSubmit() {
    ...
    setBusy(true);
    try {
      const url = asset ? `/api/maintenance/assets/${asset.asset_id}` : "/api/maintenance/assets";
